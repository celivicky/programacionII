...
if (isset($_POST['add_member'])) {
    ...
    $sql = "INSERT INTO tarea (nomcl, apecl, nomcas, sitio, state, dia, celu) VALUES ('$nomcl', '$apecl', '$nomcas', '$sitio', '$state', '$dia', '$celu')"; 
...
?>
        ...
        <div class="section-title-wrapper">
          <h2 class="section-title">Agregar tarea</h2>
...
<strong>Importante!</strong> Es importante rellenar los campos con &nbsp;<span class="badge-warning">*</span>
  ...
  <hr>
  <br>
                <label for="nomcl">Nombre del Cliente:</label>
                <input type="text" name="nomcl" required>
                
                <label for="apecl">Apellido del Cliente:</label>
                <input type="text" name="apecl" required>
                
                <label for="nomcas">Nombre del Caso:</label>
                <input type="text" name="nomcas" required>
                
                <label for="sitio">Sitio del Caso:</label>
                ...
                <label for="dia">Día del Caso:</label>
                <input type="date" name="dia" required>
                
                <label for="celu">Celular del Cliente:</label>
                <input type="text" name="celu" required>
                
                <button type="submit" name="add_member"class="registerbtn" >Crear Tarea</button>
            </form>
        </article>
    </main>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php include_once '../../backend/php/add_det_tarea.php' ?>
