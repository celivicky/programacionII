...
<head>
  ...
  <?php
    ...
    if(isset($_POST['add_member'])){
        ...
        if($result){
            echo "<script>alert('Tarea agregada exitosamente')</script>";
            header('location:attend.php?id='.$connect->insert_id);
        }else{
            echo "<script>alert('Error al agregar la tarea')</script>";
        }
    }
            ...
            <li>
              <a href="#" class="header-profile">
                ...
                <figure class="profile-avatar">
                  <img src="../../backend/img/icono avatar" alt="Elizabeth Foster" width="32" height="32">
                </figure>
...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off">
  ...
  <strong>Importante!</strong> Es importante rellenar los campos con &nbsp;<span class="badge-warning">*</span>
    ...
    <button type="submit" name="add_det_tarea" class="registerbtn">Guardar</button>
  </div>
