...
<body>
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <h1>
        <a href="../administrador/escritorio.php" class="logo">J.Shalom</a>
      </h1>
...
?>
      ...
      <section class="projects">
        ...
        <div class="section-title-wrapper">
          <h2 class="section-title">Vista de las tareas atendidas</h2>
 ...
 $id = $_GET['id'];
 $sentencia = $connect->prepare("SELECT detalle_tarea.ideta, tarea.idtarea, tarea.nomcl, tarea.apecl, tarea.nomcas, tarea.sitio, tarea.dia, tarea.celu, miembros.idmen, miembros.nomenb, miembros.apmenb, detalle_tarea.respueta, detalle_tarea.fere FROM detalle_tarea INNER JOIN tarea ON detalle_tarea.idtarea = tarea.idtarea INNER JOIN miembros ON detalle_tarea.idmen = miembros.idmen WHERE tarea.idtarea= '$id';");
 $sentencia->execute();
...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off">
  ...
  <strong>Importante!</strong> Es importante rellenar los campos con &nbsp;<span class="badge-warning">*</span>
    ...
    <textarea  name="tareresp" placeholder="Write something.." style="height:200px"><?php echo $d->respueta; ?></textarea>

    <label for="email"><b>Responsable que resolvio el caso</b></label>
    <input type="text" placeholder="ejm: Suarez" disabled value="<?php echo $d->nomenb; ?> &nbsp; <?php echo $d->apmenb; ?>"  required>
