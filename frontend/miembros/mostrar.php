...
?>
      ...
      <section class="projects">
        ...
        <div class="section-title-wrapper">
          ...
          <button class="btn-group" style="cursor: pointer;" onclick="location.href='nuevo.php'">Nuevo</button>
        </div>

        <ul class="project-list">
<?php 

$sentencia = $connect->prepare("SELECT * FROM miembros ORDER BY idmen DESC;");
 $sentencia->execute();
$data =  array();
if($sentencia){
      ...
      <?php foreach($data as $d):?>
          <li class="project-item">
            <div class="card project-card">
              ...
              <ul class="ctx-menu">
                <a href="../miembros/view.php?id=<?php echo $d->idmen ?>">
                <li class="ctx-item">
                  <button class="ctx-menu-btn icon-box">
                ...
                <a href="../miembros/edit.php?id=<?php echo $d->idmen ?>">
                <li class="ctx-item">
                  <button class="ctx-menu-btn icon-box">
                ...
                <li class="divider"></li>
                <a href="../miembros/delete.php?id=<?php echo $d->idmen ?>">
                <li class="ctx-item">
              ...
              <time class="card-date" datetime="2022-04-09"><?php echo $d->fere ?></time>

              <h3 class="card-title">
                <a href="../miembros/view.php?id=<?php echo $d->idmen ?>"><?php echo $d->nomenb ?>&nbsp;<?php echo $d->apmenb ?></a>
              </h3>

              <?php 
                    if ($d->rol= '2') {
                     echo '<div class="card-badge blue">Miembro</div>'; 
                    } 
               ?>
