...
?>
      ...
      <section class="projects">
        ...
        <div class="section-title-wrapper">
          <h2 class="section-title">Nuevos miembros</h2>
...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off">
  ...
  <strong>Importante!</strong> Es importante rellenar los campos con &nbsp;<span class="badge-warning">*</span>
    ...
    <input type="text" placeholder="ejm: Javier" name="mennom"  required>

    <label for="email"><b>Apellido del miembro</b></label><span class="badge-warning">*</span>
    <input type="text" placeholder="ejm: Suarez" name="menape"  required>
    ...
    <input type="text" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" placeholder="ejm: 999878767" maxlength="9" name="mencel"  required>

    <label for="email"><b>Usuario del miembro</b></label><span class="badge-warning">*</span>
    <input type="text" placeholder="ejm: ssuare01" name="menusu"  required>

    <label for="email"><b>Correo del miembro</b></label><span class="badge-warning">*</span>
    <input type="text" placeholder="ejm: ssuare01@gmail.com" name="mencor"  required>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php include_once '../../backend/php/add_member.php' ?>
