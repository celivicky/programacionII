        ...
        <div class="card profile-card">
          <div class="profile-card-wrapper">
            ...
            <figure class="card-avatar">
              <img src="../../backend/img/6460328.png" alt="admin" width="48" height="48">
            </figure>
...
?>
 ...
 $id = $_GET['id'];
 $sentencia = $connect->prepare("SELECT detalle_tarea.ideta, tarea.idtarea, tarea.nomcl, tarea.apecl, tarea.apecl, tarea.nomcas, tarea.sitio, tarea.dia, tarea.celu, miembros.idmen, miembros.nomenb, miembros.apmenb, detalle_tarea.respueta, detalle_tarea.fere FROM detalle_tarea INNER JOIN tarea ON detalle_tarea.idtarea = tarea.idtarea INNER JOIN miembros ON detalle_tarea.idmen = miembros.idmen WHERE tarea.idtarea= '$id';");
 $sentencia->execute();
